...
contract AmusementTokenContract is IERC20 {
    ...
    function balanceOf(address _address) external override view returns (uint256 balance){
    ...
    function transferToContract(address from, uint256 _value) external override returns (bool success){
        require(balances[from] >= _value, "Not enough tokens");
        balances[from] -= _value;
        balances[owner] += _value;
        emit Transfer(from, owner, _value);
        return true;
    }
